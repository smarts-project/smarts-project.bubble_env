...
class MujocoAgent(parl.Agent):
    ...
    def learn(self, next_value, gamma, gae_lambda, ppo_epoch, num_mini_batch, rollouts):
        ...
        for e in range(ppo_epoch):
            data_generator = rollouts.sample_batch(
                next_value, gamma, gae_lambda, num_mini_batch
            )
